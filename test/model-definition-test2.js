...
describe(chalk.blue('tenant-model-definition - REST'), function () {
  ...
  after('cleaning up', function (done) {
    ...
    var ShoppingCartModel = loopback.getModel(modelName, bootstrap.defaultContext);
    var model2 = loopback.getModel(ShoppingCartModel.modelName + 'History', bootstrap.defaultContext);
    if (model2) {
    ...
    models.ModelDefinition.destroyAll({}, bootstrap.defaultContext, function (err, result) {
      models.Tenant.destroyAll({}, bootstrap.defaultContext, function (err) {
        ...
        ShoppingCartModel.destroyAll({}, bootstrap.defaultContext, function (err, info) {
          done();
