    ...
    if (jsonifyModel.properties) {
      Object.keys(jsonifyModel.properties).forEach(function (p) {
        if (jsonifyModel.properties[p].type === 'string' || jsonifyModel.properties[p].type === 'number'
          || jsonifyModel.properties[p].type === 'boolean' || jsonifyModel.properties[p].type === 'date'
          || jsonifyModel.properties[p].type === 'object' || jsonifyModel.properties[p].type === 'timestamp'
          || jsonifyModel.properties[p].type === 'email') {
        }
          ...
          if (embeddedType === 'string' || embeddedType === 'number'
            || embeddedType === 'boolean' || embeddedType === 'date'
            || embeddedType === 'object' || embeddedType === 'timestamp' || embeddedType === 'email') {
          }
          else {
