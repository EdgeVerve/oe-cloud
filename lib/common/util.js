  ...
  if (ctxStr !== createDefaultContextString(autoscopeFields)) {
    if (jsonifyModel.relations) {
      Object.keys(jsonifyModel.relations).forEach(function (r) {
        ...
        jsonifyModel.relations[r].model = jsonifyModel.relations[r].model + '-' + createContextString(autoscopeFields, options.ctx);
        //if (!app.models[jsonifyModel.relations[r].model]) {
        //jsonifyModel.relations[r].model = jsonifyModel.relations[r].clientModel;
        //}
      });
    }
  }
