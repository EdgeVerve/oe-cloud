  ...
  async.each(Object.keys(app.models), function (model, callback) {
    if (app.models[model].definition.settings.mixins &&
      ...
      if (typeof timeToRecoverOld !== 'undefined') {
        ...
        console.log('--------- Fetching instances for model: ', Model, 'with oldUpdateTime gte: ', timeToRecoverOld, ' ---------');
        fetchLimit(Model, query, 'oldUpdateTime', function (err, MaxTimeOld) {
          ...
          if (timeToRecoverCurr !== 'undefined') {
            ...
            console.log('--------- Fetching instances for model: ', Model, 'with currentUpdateTime gte: ', timeToRecoverOld, ' ---------');
